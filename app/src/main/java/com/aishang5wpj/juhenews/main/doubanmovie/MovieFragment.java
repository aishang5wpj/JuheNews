...
public class MovieFragment extends BaseFragment implements LocationHelper.OnLocationListener, IMovieChannelView {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_movie_douban;
    }
    ...
    @Override
    public void onLoadChannelComplted(List<DoubanMovieChannelBean> channelList) {
        ...
        for (DoubanMovieChannelBean channel : channelList) {
